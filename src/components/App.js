...
const App = () => {
  ...
  const keyHandler = (event) =>{
    ...
    if(event.keyCode === 37){
      ...
      ballPositionClone.top = Number(ballPosition.top.slice(0, ballPosition.top.indexOf("p"))) - 5 + "px";
    }
  ...
  if(renderBall){
    compo =(
      <div className="ball" style={{left: ballPosition.left, top: ballPosition.top}}> </div>
    );
  }
  else{
    compo = (
